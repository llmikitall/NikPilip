...
public class FillingTests {
    ...
    void createCategoryAndProducts(){
        Category parent; // parent - объект, для создания категорий с родителем
        Category category; // category - объект, для создания продуктов с категорией
        ...
        saveProduct("Яблочный", category, "Яблоко, корица, карамель", 65.00);
        ...
        saveClient(1L,"Пилипенко Никита Михайлович",
                "ул. Великая, д. 21, кв. 1, г. Севастополь", "+79784571049");
        saveClient(2L,"Кузнецов Владислав Вячеславович",
                "ул. Кирова, д. 331, кв. 21, г. Краснодар", "+79787777777");
        saveClient(3L,"Шаматрин Владимир Антонович",
    ...
    void saveProduct(String name, Category category, String description, Double price){
    ...
    private void saveClient(Long externalID, String fullName, String address, String phoneNumber){
